...
type DriverBookingDetailsPageProps = {
  params: Promise<{
    id: string;
  }>;
};
...
export default async function DriverBookingDetailsPage({
  params,
}: DriverBookingDetailsPageProps) {
      ...
      <section className="mx-auto max-w-7xl px-4 py-10">
        <div className="mb-8">
          <p className="text-sm font-semibold uppercase tracking-widest text-blue-600">
            Driver / Bookings / Details
          </p>
          <h1 className="mt-2 text-4xl font-bold text-slate-900">
            Trip Details
          </h1>
          <p className="mt-3 text-slate-600">
            View all information for this assigned booking.
          </p>
        </div>
